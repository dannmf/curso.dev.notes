...
Claro que isso tem limites claros, não da para sair somente executando, pois isso pode ter efeitos colaterais como uma arquitetura ou modelagem ruim.

## Níveis de Organização

O nosso cérebro vem com uma configuração de fábrica, capaz de analisar o **SALDO** das coisas, dessa formas conseguimos saber se vale a pena ou não seguir com determinada tarefa, ação etc...

E isso é ótimo pois temos que ter esse controle e entender que dar 2 passos pra trás para depois dar 10 passos pra frente é um **saldo positivo**, porém dar 10 passos pra
trás para depois dar 1 para frente é um **saldo negativo**.

Para conseguir organizar isso podemos separar a organização em níveis para saber se o saldo vai ser **positivo ou negativo**
...
Exemplo: anotar as tarefas em um papel na forma mais simples possível, com apenas uma caixinha e o titulo do que precisa ser feito.
...
No nível 2 ganhamos o poder de maior distribuição do que precisa ser feito, agora no nível 3 além disso temos o poder de conversar e desenvolver de forma detalhada sobre o que precisa ser feito, isso pode ser feito através de aplicativos como por exemplo **Trello**.

Mas cuidado, pois aqui no nível 3, o **Tempo de Aquecimento** é maior, pois você precisa ativamente ir atrás daquela informação, esperar o sistema carregar etc..
...
Explicação da Tabela: Nessa tabela temos o total de tarefas, quantas foram executadas e a porcentagem de conclusão do projeto em geral (de 0 a 100%). A tabela é progressiva, pois conforme vai passando as semanas, as tarefas vão aumentando.
